                ...
                <div>
                  <div className="rvo-layout-row rvo-layout-align-items-start rvo-layout-align-content-start rvo-layout-justify-items-start rvo-layout-justify-content-start rvo-layout-gap--0">
                    ...
                    <div>
                      ...
                      <br />
                      <span className="openbsw-search-result--date">
                        {shortenUrl(item.url, 60)}
                      </span>
                    </div>
                  </div>
                </div>
...
function SearchResults({ term, baseUrl }: SearchResultsProps) {
  ...
  if (!term) {
    ...
    return <>Foutmelding: {error.message}</>;
...
export default function Search({ baseUrl }: SearchProps) {
  ...
  return (
    <div className="rvo-layout-row rvo-layout-gap--0 rvo-margin-inline-start--2xl openbsw-search-container">
      <input
        id="field"
        placeholder="Zoek collega's, dossiers of vraag hulp van je persoonlijke assistent"
        type="text"
        className="utrecht-textbox utrecht-textbox--html-input openbsw-textbox--menu"
        dir="auto"
        defaultValue=""
        onKeyUp={handleKeyUp}
        ref={inputRef}
      ...
      >
        <span
          className="utrecht-icon rvo-icon rvo-icon-zoek rvo-icon--md rvo-icon--hemelblauw"
          role="img"
